...
goatrev=MenuItemReview.create([{user_id: 1, menu_item_id: 1, rating: 5, comment: "Goat Roti is traditional and delicious. Wish it was available closer to home."}])
suprev=MenuItemReview.create([{user_id: 1, menu_item_id: 1, rating: 5, comment: "The dumplings are unbelievable."}])
caddiesbrunch=MenuItemReview.create([{user_id: 2, menu_item_id: 1, rating: 5, comment: "Sliders are best choice if you are hungry."}])
texasrev=MenuItemReview.create([{user_id: 1, menu_item_id: 1, rating: 5, comment: "Great beer list. Great wing deal!!"}])
